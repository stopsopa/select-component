...
export class ContainerManager {
  ...
  private currentPosition: PositionType = "cover-bottom";
  public propOptions: ContainerManagerOptions;
  private _subscriber = createSubscriber<ContainerManagerEvents>();
