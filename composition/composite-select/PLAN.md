...
and when creating choice.js/composition/composite-select/ContainerManager.html load
...
so in ContainerManager.html use load ESM choice.js/composition/composite-select/CompositeManager.lib.js
