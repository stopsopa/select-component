 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "select two"
 * /bin/bash playwright.sh -- --debug -g "select two" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("select two", async ({ page }) => {
  // Step 1: Navigate to the demo page.
  await page.goto("/composition/composite-select/ContainerManager.html");

  // Step 2: Remove the page description element.
  await page.locator("#page-description").evaluate((el) => el.remove());

  // Step 3: Focus and click the selected section's input to open the popover.
  await page.locator("center-and-height-resizer").getByRole("textbox").click();
  ...
  // Step 5: Click the selected section's input again (which is already focused) to reopen the popover.
  await page.locator("center-and-height-resizer").getByRole("textbox").click();
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "show footer"
 * /bin/bash playwright.sh -- --debug -g "show footer" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("show footer", async ({ page }) => {
  ...
  // Step 3: Ensure "Show Footer" checkbox is checked.
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "search"
 * /bin/bash playwright.sh -- --debug -g "search" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("search", async ({ page }) => {
  ...
  // Step 3: Check the "Show Filter" checkbox to enable the search input in the popover.
  const showFilter = page.getByRole("checkbox", { name: "Show Filter" });
  if (!(await showFilter.isChecked())) {
  ...
  // Step 5: Type "ba" into the search textbox.
  await page.getByRole("textbox", { name: "Search fruits..." }).fill("ba");

  // Step 6: Click the item "banach" from the filtered list (closes the popover).
  await page
    .locator("div")
  ...
  // Step 8: Click the item "bartik" from the list.
  await page
    .locator("div")
    .filter({ hasText: /^bartik$/ })
    .click();

  // Step 9: Validate that both "banach" and "bartik" are correctly selected.
  await compareSelectedItems(page, '[data-role="dump"]', [
    {
      id: 20,
      label: "banach",
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "error state"
 * /bin/bash playwright.sh -- --debug -g "error state" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("error state", async ({ page }) => {
  ...
  const section = await page.locator("center-and-height-resizer").locator(".selected-section");
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "loading state"
 * /bin/bash playwright.sh -- --debug -g "loading state" -- composition/composite-select/ContainerManager.e2e.ts
 */
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "disabled state"
 * /bin/bash playwright.sh -- --debug -g "disabled state" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("disabled state", async ({ page }) => {
  ...
  // Step 3: Get the selected-section wrapper element.
  const element = await page.locator("center-and-height-resizer").locator(".selected-section");
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "change label"
 * /bin/bash playwright.sh -- --debug -g "change label" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("change label", async ({ page }) => {
  ...
  const placeholder = await page.locator("center-and-height-resizer").locator(".flex-list [placeholder]");
  const floatingLabel = await page.locator("center-and-height-resizer").locator(".selected-section .floating-label");
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "clear selection"
 * /bin/bash playwright.sh -- --debug -g "clear selection" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("clear selection", async ({ page }) => {
  ...
  // Step 3: Validate that the initial selection state in the dump is empty.
  await compareSelectedItems(page, '[data-role="dump"]', "", {
    decodeJson: false,
  });
  ...
  // Step 9: Click the "✕" (clear) button.
  await page.getByRole("button", { name: "✕" }).click();

  // Step 10: Verify that the selected items list in the dump is empty.
  await compareSelectedItems(page, '[data-role="dump"]', []);
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "empty custom template"
 * /bin/bash playwright.sh -- --debug -g "empty custom template" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("empty custom template", async ({ page }) => {
  // Step 1: Navigate to the demo page with URL parameters that initialize an empty list.
  await page.goto(
    "/composition/composite-select/ContainerManager.html?l1=100px&c1=600px&h1=auto&ds1=0&do1=0&ls1=0&lo1=0&as1=Select+Fruit&ao1=Search+fruits...&es1=0&si1=1&sf1=1&st1=1&p1=cover-bottom&f1=&x1=&mh1=&el1=1",
  );
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "custom template"
 * /bin/bash playwright.sh -- --debug -g "custom template" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("custom template", async ({ page }) => {
  // Step 1: Navigate to the demo page.
  await page.goto(
    "/composition/composite-select/ContainerManager.html?l1=100px&c1=600px&h1=auto&ds1=0&do1=0&ls1=0&lo1=0&as1=Select+Fruit&ao1=Search+fruits...&es1=0&si1=1&sf1=1&st1=1&p1=cover-bottom&f1=&x1=&mh1=&el1=0",
  );
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "height"
 * /bin/bash playwright.sh -- --debug -g "height" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("height", async ({ page }) => {
  ...
  // Step 15: Select "youtube.png" template button.
  const youtubeBtn = await querySelector(page, `[data-img="youtube.png"]`);
  await youtubeBtn.click();

  // Step 16: Click "Reset" button.
  const resetBtn = await querySelector(page, `[data-value="reset"]`);
  await resetBtn.click();

  // Step 17: Click the Focus button to display the options section.
  const focusBtn4 = await querySelector(page, `[data-role="focus-btn"]`);
  await focusBtn4.click();

  // Step 18: Get style attribute of options section manager.
  const styleReset = await optionsSectionManager.getAttribute("style");

  // Step 19: Assert the inline style is "max-height: none;".
 ...
 * 
 * Commands to run:
 * /bin/bash playwright.sh -- composition/composite-select/ContainerManager.e2e.ts -g "select template"
 * /bin/bash playwright.sh -- --debug -g "select template" -- composition/composite-select/ContainerManager.e2e.ts
 */
test("select template", async ({ page }) => {
  ...
  const containerDefault = await page.locator("center-and-height-resizer").locator(".flex-list");
...
<input type=\"text\" placeholder=\" \" size=\"1\">
  ...
  const containerItem = await page.locator("center-and-height-resizer").locator(".flex-list");
...
<input type=\"text\" placeholder=\" \" size=\"1\">
  ...
  const containerList = await page.locator("center-and-height-resizer").locator(".flex-list");
  const htmlList = await containerList.innerHTML();

  // Step 16: Verify the structural layout matches grouped chunk list containers.
...
<input type=\"text\" placeholder=\" \" size=\"1\">
  ...
  const containerReset = await page.locator("center-and-height-resizer").locator(".flex-list");
