<description>
I need to create class similar to SelectedSectionManager but this time for options section.
...
in that input we will have to have similar spinner for indicating loading state as we have in SelectedSectionManager.
...
- onChange(value: string) - triggered when input value changes (that will have to have similar behaviour regarding backspace and enter like in SelectedSectionManager)
...
I need demo in choice.js/composition/options-section/OptionsSectionManager.html keep it simple, just render our web component
