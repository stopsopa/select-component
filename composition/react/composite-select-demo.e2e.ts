...
/**
 * Helper: navigate to the home page, click the "composite-select-demo" link, then click
 * "Initialize New Instance" so there is exactly one DemoInstance rendered on the page.
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts
 * /bin/bash playwright.sh -- --debug -- composition/react/composite-select-demo.e2e.ts
 */
async function gotoDemo(page: Page) {
  // Navigate to the vite dist home page.
  await page.goto("/vite-project/dist/");

  // Click the "CompositeSelect Manager Demo" link.
  await page.getByTestId("composite-select-demo").click();

  // Click "Initialize New Instance" to create instance #1.
  await page.getByRole("button", { name: "Initialize New Instance" }).click();
}
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "select two"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "select two"
 * /bin/bash playwright.sh -- --debug -g "select two" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "show footer"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "show footer"
 * /bin/bash playwright.sh -- --debug -g "show footer" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "search"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "search"
 * /bin/bash playwright.sh -- --debug -g "search" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "error state"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "error state"
 * /bin/bash playwright.sh -- --debug -g "error state" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "loading state"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "loading state"
 * /bin/bash playwright.sh -- --debug -g "loading state" -- composition/react/composite-select-demo.e2e.ts
 */
test("loading state", async ({ page }) => {
  ...
  const loadingCheckbox = page.getByLabel("Loading").first();
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "disabled state"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "disabled state"
 * /bin/bash playwright.sh -- --debug -g "disabled state" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "change label"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "change label"
 * /bin/bash playwright.sh -- --debug -g "change label" -- composition/react/composite-select-demo.e2e.ts
 */
test("change label", async ({ page }) => {
  ...
  // Step 3: Confirm the default input value is "default value" (set by the React demo URL param default).
  const valueBefore = await placeholder.inputValue();
  expect(valueBefore).toEqual("default value");
  ...
  await expect(async () => {
    // Step 6: Confirm the input value is still "default value" (unchanged by label update).
    const valueAfter = await placeholder.inputValue();
    expect(valueAfter).toEqual("default value");
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "clear selection"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "clear selection"
 * /bin/bash playwright.sh -- --debug -g "clear selection" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "empty custom template"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "empty custom template"
 * /bin/bash playwright.sh -- --debug -g "empty custom template" -- composition/react/composite-select-demo.e2e.ts
 */
test("empty custom template", async ({ page }) => {
  ...
  // Step 8: Get the options list container element.
  const elementCustom = await querySelector(page, `.options`);

  await page.getByRole("button", { name: "Focus Input" }).click();

  // Step 9: Get the HTML content of the options list container.
  ...
  // Step 12: Get the options list container element.
  const elementFallback = await querySelector(page, `.options`);

  await page.getByRole("button", { name: "Focus Input" }).click();

  // Step 13: Get the HTML content of the options list container.
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "fn custom template"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "fn custom template"
 * /bin/bash playwright.sh -- --debug -g "fn custom template" -- composition/react/composite-select-demo.e2e.ts
 */
test("fn custom template", async ({ page }) => {
  // Step 1: Navigate to the demo page.
  await gotoDemo(page);
  ...
  expect(htmlCustom).toContain("❄️");
  expect(htmlCustom).toContain("allen");
  ...
  const processed = htmlString
    ...
    .map((t) => t.trim())
    .join("");
  expect(processed).toContain("allen");
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "height"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "height"
 * /bin/bash playwright.sh -- --debug -g "height" -- composition/react/composite-select-demo.e2e.ts
 */
 ...
 *
 * Commands to run:
 * /bin/bash playwright.sh           -- composition/react/composite-select-demo.e2e.ts -g "select template"
 * /bin/bash playwright.sh -t docker -- composition/react/composite-select-demo.e2e.ts -g "select template"
 * /bin/bash playwright.sh -- --debug -g "select template" -- composition/react/composite-select-demo.e2e.ts
 */
...
<input type=\"text\" placeholder=\" \" size=\"1\">
  ...
  await expect(async () => {
    // Step 12: Get HTML content of the selection list wrapper container.
    const htmlItem = await containerDefault.innerHTML();

    // Step 13: Verify that item elements are rendered using the custom style/border.
    expect(htmlItem).toContain('data-id="10"');
    expect(htmlItem).toContain("border: 2px solid");
    expect(htmlItem).toContain("agnesi");
    expect(htmlItem).toContain('src="/img/gemini.png"');
  }).toPass({
    timeout: 3000,
    intervals: [500],
  });
  ...
  await expect(async () => {
    // Step 15: Get HTML content of the selection list wrapper container.
    const htmlList = await containerDefault.innerHTML();
    // Step 16: Verify the structural layout uses grouped chunk list containers.
    expect(htmlList).toContain("border: 1px solid rgb(26, 115, 232)");
    expect(htmlList).toContain("border-radius: 8px");
    expect(htmlList).toContain("agnesi");
    expect(htmlList).toContain("gemini");
  }).toPass({
    timeout: 3000,
    intervals: [500],
  });
  ...
  await expect(async () => {
    // Step 18: Get HTML content of the selection list wrapper container.
