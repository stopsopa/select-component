import { urlManipulationFactory, createStringParam, createBooleanParam, createArrayParam, } from "../composite-select/urlManager.js";
...
export const urlStateConfig = urlManipulationFactory({
    selected: createArrayParam("v", (item) => {
